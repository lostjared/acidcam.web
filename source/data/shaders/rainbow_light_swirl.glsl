...
void main(void) {
    ...
    vec3 rainbow_FragColor = rainbow(new_angle / (2.0 * 3.14159));
    vec3 blended_FragColor = mix(texColor.rgb * lightColor, rainbow_FragColor, 0.5);

    FragColor = vec4(sin(blended_FragColor * t), texColor.a);
}
