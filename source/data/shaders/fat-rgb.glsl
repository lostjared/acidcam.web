...
void main(void) {
    ...
    if (channel == 0) {
        FragColor = vec4(streTexCoordhed_FragColor.r, original_FragColor.g, original_FragColor.b, original_FragColor.a);
    } else if (channel == 1) {
        FragColor = vec4(original_FragColor.r, streTexCoordhed_FragColor.g, original_FragColor.b, original_FragColor.a);
    } else {
        FragColor = vec4(original_FragColor.r, original_FragColor.g, streTexCoordhed_FragColor.b, original_FragColor.a);
    }
}
